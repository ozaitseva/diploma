...
![Виртуальный адрес на платформе x86-64](http://www.dropbox.com/s/o5hehbjnwohibau/virt_adr.jpg?dl=0 "Виртуальный адрес на платформе x86-64")

![Структуры преобразования адресов на платформе x86-64](http://www.dropbox.com/s/3x8y3hnj76bp73t/transl_adr.jpg?dl=0 "Структуры преобразования адресов на платформе x86-64")
...
![Аппаратная запись таблицы страниц на платформе x86-64](http://www.dropbox.com/s/2ko30ytldgp2yd7/pte.jpg?dl=0 "Аппаратная запись таблицы страниц на платформе x86-64")
