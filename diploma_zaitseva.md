...
Используя эти данные, можно проводить анализ системы, основываясь на том, какие приложения запущены. Также стоит обратить внимание и на системные процессы. 
