...
Основной блок куста, представленный структурой *\_HBASE\_BLOCK* также имеет свою константную сигнатуру - *regf* или *0x66676572*. В данной структуре хранится с
...
Поле *BlockAddress* содержит виртуальный адрес начала структуры *\_HBIN*. Таким образом, добавив к данному адресу смещение (последние 12 бит), получим адрес, 
ссылающийся на необходимые нам данные.
