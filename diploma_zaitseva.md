...
Также с помощью реализованного алгоритма удалось установить список файлов реестра, а именно имя файла реестра, физический адрес хайва, а также удалось осуществить трансляцию индекса ячейки каждого хайва с последующей целью обхода узлов реестра. (//? обход не получается осуществить, не могу разобраться, что за странный указатель на subkeys, как лучше это описать?) 
...
В дальнейшем планируется создать автоматизированный программный комплекс, задача которого состоит в неинвазивном анализе динамики оперативной памяти гостевых операционных систем. Разработанный парсер дампов является частью данного комплекса.
